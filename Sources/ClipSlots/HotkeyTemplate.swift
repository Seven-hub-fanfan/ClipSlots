...
enum HotkeyTemplateKind: String, Codable, CaseIterable, Identifiable {
    case hybrid = "hybrid"
...
struct HotkeyTemplate: Codable, Equatable {
    var kind: HotkeyTemplateKind = .numeric
    var customKeys: [String] = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"]

    /// Return the single-character key token for a given slot (1-based).
    func keyToken(for slot: Int) -> String? {
